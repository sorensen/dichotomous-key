      ...
      <section id="dashboard">
        <div className="container">
          ...
          <div className="row">
            ...
            Each page will present you with 2 choices. Pick the one that matches your insect the best.
            ...
            descriptions from the key, and sometimes will tell you what the insect is. When you get to the Order page, you will get a description of that
            order.
            </p>
            <p>
            This key will only get you to the Order of the insect you find. That means that you will
            have a very general idea of where your insect belongs. If you want more information or
            help with identification, check the Resources page in the menu. Figuring
            out the family, genus, and even species will help you get the exact right insect.
            </p>
            <p>
            Some of the questions in the key require you to get up close and personal with your insect.
            The easiest way to do this is to put the insect to sleep or to kill it. The most humane way
            to kill an insect is by freezing. Place the insect in a jar and put it in the freezer overnight.
            If you only want to make it sleepy, put it in the freezer for 15 minutes to half an hour.
            Check your insect to make sure it’s slowed down or isn’t moving before you remove it from the freezer.
            ...
            page for more information on insect catching tools.
            </p>
            <p>
            Have fun!<br />
            Liz Sorensen
